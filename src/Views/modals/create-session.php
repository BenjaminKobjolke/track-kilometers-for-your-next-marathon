    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?= $translator->get('modal_title_create_session') ?></h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" form="createSessionForm"><?= $translator->get('button_create') ?></button>
            </div>
        </div>
    </div>
</div>
