    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        <h2 class="text-center mb-4"><?= $translator->get('heading_login') ?></h2>
                        ...
                        <form id="loginForm">
                            <div class="mb-3">
                                <label for="email" class="form-label"><?= $translator->get('label_email') ?></label>
                            ...
                            <div class="mb-3 form-check">
                                ...
                                <label class="form-check-label" for="rememberMe"><?= $translator->get('label_remember_me') ?></label>
                            </div>
                            <button type="submit" class="btn btn-primary w-100"><?= $translator->get('button_login') ?></button>
                            <div class="text-center mt-3">
                                <a href="#" id="forgotPassword" data-bs-toggle="modal" data-bs-target="#resetPasswordModal"><?= $translator->get('link_forgot_password') ?></a>
                                <div class="mt-2">
                                    <a href="<?= $config['base_url'] ?>/register.php"><?= $translator->get('link_register') ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
